/*
  ...
  - Adds `user_id` to `chat_sessions` and `user_preferences`.
  - Adds `save_chat_history` toggle to `user_preferences`.
  - Replaces open “Anyone can ...” RLS policies with `auth.uid()` scoped policies.
*/
